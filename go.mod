module github.com/JohnKucharsky/WarehouseAPI
...
require (
	...
	github.com/induzo/gocom/database/pginit/v2 v2.2.3
...
require (
	...
	github.com/induzo/gocom/database/pgx-slog v1.0.6 // indirect
